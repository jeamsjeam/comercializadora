<?php
    ...
    function obtenerPorId($datos) {
        ...
        try{
            ...
            $sql = "SELECT * FROM monedas WHERE id = ".$datos['id'];
    ...
    function ObtenerPorListaId($datos) {
        ...
        try{
            // Consulta a la base de datos
            $sql = "SELECT * FROM monedas WHERE id in (";
            foreach ($datos as $id) {
                $sql .= $id.",";
            }
            $sql = rtrim($sql, ',').")";
    ...
    function insertar($datos) {
        ...
        try {
            // Consulta a la base de datos
            $sql = "INSERT INTO monedas (nombre, fecha_creacion) VALUES ";
    ...
    function actualizarLista($datos) {
        ...
        try {
            ...
            foreach ($datos as $dato) {
                ...
                $sql_update = "UPDATE monedas SET nombre = '".$dato['nombre']."' WHERE id = ".$dato['id'];
    ...
    function eliminar($datos) {
        ...
        try {
            ...
            // Consulta a la base de datos
            $sql = "DELETE FROM monedas WHERE id = ".$datos['id'];
    ...
    function eliminarLista($datos) {
        ...
        try {
            ...
            $sql = "DELETE FROM monedas WHERE id IN (";
